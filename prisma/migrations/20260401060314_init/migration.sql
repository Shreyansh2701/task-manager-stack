...
-- CreateEnum
CREATE TYPE "ProjectView" AS ENUM ('BOARD', 'LIST');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'TASK_UPDATED', 'TASK_DUE_SOON', 'COMMENT_ADDED', 'MENTIONED', 'MEMBER_JOINED', 'INVITE_RECEIVED');
...
CREATE TABLE "projects" (
    ...
    "name" TEXT NOT NULL,
    "description" TEXT,
    "defaultView" "ProjectView" NOT NULL DEFAULT 'BOARD',
